      ...
      <main className="mx-auto flex max-w-4xl flex-col gap-10 px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <header className="space-y-3">
          ...
          <p className="max-w-2xl text-base leading-relaxed text-zinc-600 sm:text-lg">
            How the war is turned into a visual style, mood or brand across
            feeds and formats.
          </p>
        </header>
        ...
        <section className="space-y-6">
          ...
          <p className="text-sm leading-relaxed text-zinc-700">
            ...
            editing conventions that aestheticize conflict. You might map
            tensions between stylistic polish and the gravity of events.
          </p>
        </section>
